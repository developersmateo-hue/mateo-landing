...
const Header = ({ language, setLanguage, theme, setTheme, t }) => {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full right-0 mt-2 bg-white/10 backdrop-blur-md rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 min-w-[150px]">
                {languages.map((lang) => (
                  <button
                    key={lang.code}
