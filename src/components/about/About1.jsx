...
const AnimatedStat = ({ number, label, icon: Icon }) => {
  ...
  return (
    ...
    >
      ...
      <div className="text-3xl font-bold text-gradient mb-2" aria-live="polite">
          ...
          >
            <div className="relative z-10">
              <img
                ...
                alt="Team of AI developers working" src="https://images.unsplash.com/photo-1684369175809-f9642140a1bd" loading="lazy" />
            </div>
