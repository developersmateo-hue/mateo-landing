          ...
          >
            <div className="relative z-10">
              <img  
                ...
                alt="AI Technology Dashboard" src="https://images.unsplash.com/photo-1677442136019-21780ecad995" loading="lazy" />
            </div>
            
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full opacity-20 blur-xl" aria-hidden="true"></div>
            <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-gradient-to-r from-green-500 to-blue-500 rounded-full opacity-20 blur-xl" aria-hidden="true"></div>
          </motion.div>
        </div>
      </div>
